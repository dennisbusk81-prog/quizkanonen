...
export async function POST(request: NextRequest, { params }: Params) {
  ...
  try {
    ...
    if (logErr) console.error('[reset-season/org] admin_actions-logging feilet', orgId, logErr)
  } catch (err) {
    console.error('[reset-season/org] admin_actions-logging kastet', orgId, err)
  }
