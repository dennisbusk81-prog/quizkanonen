...
const s = {
  ...
  heroEyebrow:  { fontSize: 10, fontWeight: 600, letterSpacing: '0.18em', textTransform: 'uppercase' as const, color: '#7a7873', marginBottom: 4 },
  heroNum:      { fontFamily: "'Libre Baskerville', serif", fontSize: 64, fontWeight: 700, color: '#c9a84c', lineHeight: 1, marginBottom: 4 },
  heroNumLabel: { fontSize: 12, color: '#7a7873', letterSpacing: '0.06em', marginBottom: 10 },
  heroSub:      { fontSize: 13, color: '#7a7873' },
  ...
  graphLabel:   { fontSize: 11, fontWeight: 600, letterSpacing: '0.14em', textTransform: 'uppercase' as const, color: '#7a7873' },
  ...
  progNeutral:  { marginTop: 8, borderRadius: 8, padding: '7px 12px', fontSize: 12, fontWeight: 500, background: 'rgba(106,104,96,0.1)', border: '1px solid #2a2d38', color: '#7a7873' },
  graphEmpty:   { padding: '20px 0', textAlign: 'center' as const, fontSize: 13, color: '#7a7873', fontStyle: 'italic' as const },
  ...
  featuredCtx:  { fontSize: 10, color: '#7a7873', lineHeight: 1.4 },
  ...
  smallLbl:     { fontSize: 9, fontWeight: 600, letterSpacing: '0.06em', textTransform: 'uppercase' as const, color: '#7a7873', lineHeight: 1.3 },
  ...
  rowMeta:  { fontSize: 11, color: '#7a7873' },
          ...
          {gridYValues.map((v) => (
            <g key={v}>
              ...
              <text x={GP.left - 6} y={getY(v)} textAnchor="end" dominantBaseline="middle"
                fontSize={9} fill="#7a7873" style={{ fontFamily: "'Instrument Sans', sans-serif" }}>
                {v}%
              </text>
            </g>
          ))}
