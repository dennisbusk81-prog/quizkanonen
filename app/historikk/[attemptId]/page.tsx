...
const s = {
  ...
  ansTime:    { fontSize: 10, color: '#918f8a', marginTop: 6, textAlign: 'right' as const },
  ...
  wrongTime:    { fontSize: 10, color: '#918f8a', marginTop: 6, textAlign: 'right' as const },

  // No-answer elements
  dashIcon:   { fontSize: 14, color: '#918f8a', marginTop: 1, flexShrink: 0 },
  qTextGrey:  { fontSize: 12, color: '#918f8a', lineHeight: 1.4, flex: 1 },
    ...
    <div style={s.qCardCorrect}>
      ...
      <div style={{ flex: 1 }}>
        <div style={s.qTextShort}>
          <span style={{ fontSize: 10, color: '#918f8a', marginRight: 6 }}>Q{num}</span>
          {a.question_text}
        </div>
    ...
    <div style={s.qCardWrong}>
      ...
      <div style={s.wrongAnswers}>
        {a.selected_answer ? (
          ...
          <div style={{ ...s.ansWrong, color: '#918f8a' }}>— Svarte ikke</div>
        )}
