...
const s = {
  ...
  rowArrow:  { fontSize: 14, color: '#6a6860' },

  createCard:  { background: '#21242e', border: '1px solid #2a2d38', borderRadius: 16, padding: '20px 20px', marginBottom: 16 },
  createLabel: { fontSize: 10, fontWeight: 600, letterSpacing: '0.18em', textTransform: 'uppercase' as const, color: '#6a6860', marginBottom: 10 },
  ...
  btnGoldDis:  { padding: '10px 20px', background: '#3a3d4a', color: '#6a6860', border: 'none', borderRadius: 10, fontSize: 14, fontWeight: 700, fontFamily: "'Instrument Sans', sans-serif", cursor: 'not-allowed' },
  cancelBtn:   { marginTop: 10, background: 'none', border: 'none', fontSize: 12, color: '#6a6860', cursor: 'pointer', padding: 0, fontFamily: "'Instrument Sans', sans-serif" },
  createErrMsg:{ fontSize: 12, color: '#f87171', marginTop: 8 },

  openCreateBtn: { padding: '10px 20px', background: '#c9a84c', color: '#0f0f10', border: 'none', borderRadius: 10, fontSize: 14, fontWeight: 700, fontFamily: "'Instrument Sans', sans-serif", cursor: 'pointer', marginBottom: 20 },
  ...
  emptySub:   { fontSize: 13, color: '#6a6860', lineHeight: 1.6 },
  ...
  ctaSub:   { fontSize: 13, color: '#6a6860', marginBottom: 16, lineHeight: 1.5 },
