...
const items = [
  {
    ...
    content: 'Ny quiz hver fredag med 15 spørsmål. Du har begrenset tid per spørsmål — jo raskere du svarer riktig, desto høyere plassering. Etter quizen ser du score og svartid. Med Premium får du nøyaktig plassering og alle resultatene.',
    link: null,
  },
  {
